...
<body onselectstart="return false;" onmousedown="return false;">
  ...
  <div class="scorehyou">
    ...
    //試合回数計算(訳取得履歴から)
    $siaikaisu = $ace_ + $duce_ + $three_ + $four_ + $five_ + $six_ + $choice_ + $fullhouse_ + $fourdice_ + $smallstraight_ + $bigstraight_ + $yacht_;

    //最後まで役を埋めたら試合データがセッションに
    //格納されてsingle_result.phpへ遷移
    if ($siaikaisu >= 12) {
      session_start();
      ...
      $_SESSION['fullhouse'] = $fullhouse;
      $_SESSION['fourdice'] = $fourdice;
      $_SESSION['smallstraight'] = $smallstraight;
      $_SESSION['bigstraight'] = $bigstraight;
      $_SESSION['yacht'] = $yacht;
      $_SESSION['sum'] = $sum;
  ...
  <div class="keisanhyou">
    ...
    <form action="single_gote.php" method="POST">
